...
class ServiceCatalogue:
    def __init__(self, params):
        ...
        self.environments_get = (
            f'{self.environments}?populate[component]=true'
            f'{pagination_page_size}{sort_filter}'
        )
  ...
  """
    ...
    def get_with_retry(
        ...
        for p in range(2, page_count + 1):
            ...
            try:
                page_json = self._request_json_with_retry(
                    page_url, max_retries, timeout
                )
    ...
    def get_single_record_with_retry(
        ...
        try:
            ...
            if isinstance(data_obj, dict):
                ...
                log_warning(
                    f'Unexpected data format for single record: {type(data_obj)}'
                )
        except Exception as e:
  ...
  """
    ...
    def get_id(self, match_table, match_field, match_string):
        uri = f'{match_table}?filters[{match_field}][$eq]={match_string.replace("&", "&amp;")}'
    ...
    def find_all_teams_ref_in_sc(self):
        ...
        for component in components:
            ...
            combined_teams.update(
                component.get('github_project_teams_maintain', []) or []
            )
